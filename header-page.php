...
<html lang="ru">
  ...
  <body>
    ...
    <!-- /.navbar -->
    <header class="header-bg-grey <?= $header_style ?>">
      <div class="container">
  ...
  <!-- Обёртка слайдера -->
  <ul class="swiper-wrapper header-features header-features-about">
    <!-- слайды -->
    <li class="swiper-slide header-features-item-about">
      <svg width="36" height="36">
      <use href="img/sprite.svg#time"></use>
      </svg>
      <p class="header-features-text-about">Непрерывная работа c 2017 года</p>
    </li>
    <li class="swiper-slide header-features-item-about">
      <svg width="36" height="36">
        <use href="img/sprite.svg#cetificate"></use>
      </svg>
      <p class="header-features-text-about">Вся продукция сертифицирована</p>
    </li>
    <li class="swiper-slide header-features-item-about">
      <svg width="36" height="36">
        <use href="img/sprite.svg#control"></use>
      </svg>
      <p class="header-features-text-about">Контроль качества на всех этапах</p>
    </li>
    <li class="swiper-slide header-features-item-about">
      <svg width="36" height="36">
        <use href="img/sprite.svg#deliveri"></use>
      </svg>
      <p class="header-features-text-about">Возможны поставки по всей России</p>
    </li>
    <li class="swiper-slide header-features-item-about">
      <svg width="36" height="36">
        <use href="img/sprite.svg#speed"></use>
      </svg>
      <p class="header-features-text-about">Оперативное производство</p>
    </li>
  </ul>
